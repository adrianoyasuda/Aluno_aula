    ...
    <div class="container theme-showcase" role="main">
        ...
        <div class="page-header">
            <h2 class="form-signin-heading">
                <div id="m_texto"> Alterar Aula </div>
            </h2>
        </div>
        ...
        <form class="form" method="post" action="viewEventoAlterar.php">
            ...
            <div class='row'>
                <div class="col-sm-3">
                    <label>Data: </label>
                    <input type="date" name="data" value="<?php echo $_GET['data']; ?>" class="form-control">
                </div>

                <div class="col-sm-3">
                    <label>Responsavel: </label>
                    <input type="text" name="conteudo" value="<?php echo $_GET['conteudo']; ?>" class="form-control">
                </div>
            </div>
